...
if __name__=='__main__':
    ...
    en=translate(transformer,'Zwei Männer unterhalten sich mit zwei Frauen, Zwei Männer unterhalten sich mit zwei Frauen, Zwei Männer unterhalten sich mit zwei Frauen, Zwei Männer unterhalten sich mit zwei Frauen')
    print(en)
'''
    # 测试数据
    for i in range(2):
